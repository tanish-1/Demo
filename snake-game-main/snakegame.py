...
def endGame(score):
    ...
    score_msg_final = score_font.render(f"Final Score: {score}", 1, pygame.Color("red"))
    screen.blit(score_msg_final, (320, 300))
    ...
    high_scores = high_scores[:5]  # Keep the top 5 high scores
